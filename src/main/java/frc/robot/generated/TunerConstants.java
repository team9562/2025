...
public class TunerConstants {
    ...
    private static final Slot0Configs steerGains = new Slot0Configs()
        .withKP(115).withKI(0).withKD(0.8)
    ...
    private static final AudioConfigs kAudioConfigs = new AudioConfigs().withAllowMusicDurDisable(true);

    // Initial configs for the drive and steer motors and the azimuth encoder; these cannot be null.
    // Some configs will be overwritten; check the `with*InitialConfigs()` API documentation.
    private static final TalonFXConfiguration driveInitialConfigs = new TalonFXConfiguration().withAudio(kAudioConfigs);
    ...
    private static final Angle kBackLeftEncoderOffset = Rotations.of(0.107177734375);
